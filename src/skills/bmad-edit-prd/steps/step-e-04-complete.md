...
validationWorkflow: '{project-root}/_bmad/bmm-skills/2-plan-workflows/create-prd/steps/step-v-01-discovery.md'
---
...
- **IF V (Run Full Validation):**
  ...
  - Read fully and follow: {validationWorkflow} (steps/step-v-01-discovery.md)
