...
**[V] Run Validation** - Execute full validation workflow (./steps/step-v-01-discovery.md)
...
- IF V (Validate): Display "Starting validation workflow..." then read fully and follow: `./steps/step-v-01-discovery.md`
