---
name: bmad-method-setup
description: Sets up BMad Method module in a project. Use when the user requests to 'install bmm module', 'configure bmad method', or 'setup bmad method'.
---
